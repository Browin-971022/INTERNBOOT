...
class LMS:
    ...
    It has totatl four module: "Display Books", "Issue Books", "Return Books", "Add Books" """
    def _init_(self,ist_of_books, library_name):
...
def Issue_books(self):
    ...
    if books_id in self.books_dict.key():
        ...
        self.books_dict[books_id]['lender'] = your_name
    ...
    def add_books(self):
        ...
        if new_books =="":
            ...
            print("Books title lenght is to long!!! Title lenght should be 20 characters")
            return self.add_books()
        else:
            with open(self.list_of_books, "a") as bk:
                bk.writelines(f"{new_books}\n")
                self.books_dict.update({str(int(max(self.books_dict))+1):{'books_title':new_books,'lender_name':"",
                'Issue_date':"",'Status':"Avaiable"}})
    ...
    def return_books(self):
        ...
        if books_id in self.books_dict.keys():
            if self.books_dict[books_id]["Status"] == "Available":
                ...
                self.books_dict["Status"] = "Available"
...
while not(key_press == "q"):
        print(f"\n-------------- Welcome to {myLMS.library_name} Library Mangement System----------\n")
